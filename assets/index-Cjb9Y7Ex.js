...
`;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    ...
    {
      ref: canvasRef,
      className: "absolute top-0 left-0 inset-0 w-full h-full pointer-events-none -z-10 bg-transparent"
    }
  );
}
function r(e) {
...
function Settings({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center items-center w-full", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ref,
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-lg  text-[#726762] font-bold top-2 absolute px-4 mb-2", children: "settings" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center px-4 w-full", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-2 w-full border-t border-black/80", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "pl-5 text-sm font-medium text-black ", children: "sounds" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center mb-4 w-50 gap-3", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center w-50 gap-3", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col border-t border-black/80 mt-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-medium text-black", children: "timer" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-light text-black", children: "work:" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "input",
                {
                  type: "number",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-light text-black ml-2", children: "break:" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "input",
                {
                  type: "number",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col mt-3 border-t border-black/80", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-medium text-black", children: "color" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-5 gap-2 w-40 ml-5", children: Array.from({ length: 10 }).map((_, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
...
function App() {
  const [isWork, setIsWork] = reactExports.useState(true);
  const [isRunning, setIsRunning] = reactExports.useState(false);
  const [workDuration, setWorkDuration] = reactExports.useState(25);
  ...
  const [timeLeft, setTimeLeft] = reactExports.useState(WORK_TIME);
  const [isSettingsOpen, setIsSettingsOpen] = reactExports.useState(false);
  const [bellVolume, setBellVolume] = reactExports.useState(1);
  const [musicVolume, setMusicVolume] = reactExports.useState(1);
  const [prevBellVolume, setPrevBellVolume] = reactExports.useState(1);
  const [prevMusicVolume, setPrevMusicVolume] = reactExports.useState(1);
  const bellEnabled = bellVolume > 0;
  const musicEnabled = musicVolume > 0;
  const bgmRef = reactExports.useRef(null);
  const bellRef = reactExports.useRef(null);
  const breakRef = reactExports.useRef(null);
  reactExports.useEffect(() => {
    if (!isRunning) return;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 bg-[#00000000] mx-auto flex justify-center items-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-[220px] h-[220px] mt-6 flex flex-col items-center justify-center text-[#E7E7E8]", children: [
      isRunning && timeLeft <= 5 && timeLeft > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(CountdownOverlay, { number: timeLeft }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { width: "220", height: "220", className: "absolute mb-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "circle",
          {
            cx: "110",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-5xl font-bold", children: [
        minutes,
        ":",
        seconds
      ] }),
